...
namespace Negocio
{
    public class MarcaNegocio
    {
        ...
        public List<Marca> listarMarcandoInactivas()
        {
            List<Marca> listaMarca = new List<Marca>();
            AccesoDatos datos = new AccesoDatos();
        ...
        public void alternarEstado(int idMarca)
        {
            AccesoDatos datos = new AccesoDatos();

            try
            {
                datos.setearConsulta("UPDATE MARCAS SET Activo = CASE WHEN Activo = 1 THEN 0 ELSE 1 END WHERE Id = @IdMarca");
