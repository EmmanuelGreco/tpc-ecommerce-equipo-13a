...
namespace Negocio
{
    public class EmpleadoNegocio
    {
        ...
        public void modificar(int idEmpleado, int legajo, DateTime fechaIngreso, DateTime? fechaDespido,
                              string documento, string nombre, string apellido, DateTime fechaNacimiento, long telefono,
        ...
        public void agregar(int legajo, DateTime fechaIngreso, DateTime? fechaDespido,
                              string documento, string nombre, string apellido, DateTime fechaNacimiento, long telefono,
                              string direccion, string codigoPostal, string email, string contrasenia)
        {
            ...
            try
            {
                ...
                datos.setearConsulta(@"INSERT INTO EMPLEADOS (IdUsuario, Legajo, FechaIngreso, FechaDespido) 
                                       VALUES (@IdInsertado, @Legajo, @FechaIngreso, @FechaDespido);");
