...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
        <style>
        .chk-filtro input[type="checkbox"] {
            margin-right: 8px;
        }
    </style>
</asp:Content>
                ...
                <div class="col-md-3">
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <h6>Categorías</h6>
                            <asp:CheckBoxList ID="cblCategorias" runat="server" CssClass="chk-filtro form-check"
                            ...
                            <h6>Marcas</h6>
                            <asp:CheckBoxList ID="cblMarcas" runat="server" CssClass="chk-filtro form-check"
                                AutoPostBack="true" OnSelectedIndexChanged="Filtros_Changed"
                                RepeatLayout="Flow" RepeatDirection="Vertical">
                            </asp:CheckBoxList>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="mb-4">
                                ...
                                <asp:TextBox runat="server" ID="txtFiltroRapido" CssClass="form-control"
                                    AutoPostBack="true" OnTextChanged="filtroRapido_TextChanged" />
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="col">
                                    <div class="card h-100">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-12">
                                                    <asp:HyperLink ID="lnkVer" runat="server"
                                                        ...
                                                        Text="Ver"
                                                        NavigateUrl='<%# "ProductoDetalle.aspx?id=" + Eval("Id") %>'>
                                                    </asp:HyperLink>
                                                </div>
                                            </div>
                                            ...
                                            <asp:CustomValidator ID="cvStock" runat="server" ControlToValidate="cantidadElegida"
                                        ...
                                        <div class="card-footer d-flex justify-content-between">
                                            ...
                                            <small class="text-muted">Stock disponible: <%# Eval("Stock") %>u</small>
                                        </div>
