...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container  w-100">
        <div class="row">
            <div class="col-md-6">
                <asp:Label runat="server" CssClass="form-label" for="txtContrasenia">Contraseña actual:</asp:Label>
                <asp:TextBox ID="txtContraseniaActual" CssClass="form-control" TextMode="password" runat="server"></asp:TextBox>
                <div style="min-height: 3em;">
                    <asp:RequiredFieldValidator ErrorMessage="El campo no puede estar vacío" ForeColor="Red" Display="Dynamic" ControlToValidate="txtContraseniaActual" runat="server" />
