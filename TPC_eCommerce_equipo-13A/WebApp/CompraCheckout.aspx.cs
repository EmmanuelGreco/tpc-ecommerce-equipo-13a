    ...
    public partial class CompraCheckout : System.Web.UI.Page
    {
        ...
        protected void btnConfirmarCompra_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (venta.MetodoPago == PaymentMethod.MercadoPago)
                {
                    ...
                    Producto productoParaMercadoPago = new Producto
                    {
                        Nombre = "Compra #" + idVenta,
                        Precio = total
                    };

                    string urlPago = mpNegocio.PagarMercadoPago(productoParaMercadoPago);

                    Response.Redirect(urlPago, false);
                    return;
                }

                Response.Redirect($"CompraExitosa.aspx?idVenta={idVenta}&status=approved", false);
            }
            catch (Exception ex)
            {
